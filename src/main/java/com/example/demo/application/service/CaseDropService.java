...
public class CaseDropService {
    ...
    public SkinEntity getDroppedSkin(CaseBaseDto caseBaseInfo, double winningChance){
    ...
    public SkinDto dropSkin(CaseBaseDto caseBaseInfo, double winningChance, long userId){
